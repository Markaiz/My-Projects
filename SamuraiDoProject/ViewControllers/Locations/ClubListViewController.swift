...
class ClubListViewController: UIViewController ,UITableViewDataSource,UITableViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        tableView.backgroundView = UIImageView(image: #imageLiteral(resourceName: "ImgLocations"))
        refreshData()
    ...
    func refreshData(){
        self.tableArray = JudoClub.allClubs()
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! JudoClubCell
